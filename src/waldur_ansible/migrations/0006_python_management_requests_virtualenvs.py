# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2018-02-19 17:03
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('waldur_ansible', '0005_add_job_deleting_status'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('python_management', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='waldur_ansible.PythonManagement')),
            ],
            options={
                'abstract': False,
            },
            bases=(waldur_ansible.models.BackendProcessablePythonManagementRequest, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initialization_request', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sychronization_requests', to='waldur_ansible.PythonManagementInitializeRequest')),
                ('python_management', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='waldur_ansible.PythonManagement')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=150, validators=[waldur_core.core.validators.validate_name], verbose_name='name')),
                ('uuid', waldur_core.core.fields.UUIDField()),
                ('python_management', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='virtual_environments', to='waldur_ansible.PythonManagement')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='installed_libraries', to='waldur_ansible.VirtualEnvironment'),
        ),
